...
if is_student and is_child:
    ...
    print("Cel putin una este falsa!")
# CODUL TĂU VINE MAI SUS:
...
if is_student or is_child:
    print("Cel putin una este adevarata!")
...
# CODUL TĂU VINE MAI JOS:
if not is_student:
    print("is_student is false")
else:
    print("is_student is true")
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
number4=200000000000000000000000000000000
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
numar_mare=100000000000000000000000000000000000000000
# CODUL TĂU VINE MAI SUS:
