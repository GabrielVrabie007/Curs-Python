...
def task_4():
    ...
    for row in range(len(matrix)):
        for col in range(len(matrix)):
            simple_list.append(matrix[row][col])
    return simple_list
...
"""
Task: Creați o funcție cu numele "task_5" care utilizând list comprehension va returna o listă 
care conține string-ul "par" sau "impar" pentru fiecare număr de la 1 până la 10.
Funcția va primi ca argument un număr n care va reprezenta numărul până la care se va face impartirea.
...
def task_5(n):
    ...
    num_properties=["par" if n%2==0 else "impar" for n in range(1,11)]
...
# CODUL TĂU VINE MAI JOS:
def task_7(n):
    multiplii_de_3 = {num for num in range(1, n) if num % 3 == 0}
    return multiplii_de_3
# CODUL TĂU VINE MAI SUS:
...
returnează textul "minor" dacă vârsta este sub 18 ani, "adult" dacă vârsta este între 18 și 65 ani și "senior" dacă vârsta este peste 65 de ani.
...
def is_armstrong(number):
    ...
    for digit_char in num_str:
        ...
        sum_of_num_powers += digit ** num_digits
    return sum_of_num_powers == number
