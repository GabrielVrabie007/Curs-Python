...
telefon=Produs("Iphone",28000,2023)
...
# iphone = Telefon("Iphone", 29000, 2024, 3500, 64)
# print(iphone.numele)
# print(iphone.pretul)
# print(iphone.anul_producerii)
# print(iphone.baterie_mAh)
# print(iphone.memorie_GB)
#
#
# iphone.upgrade_memory(128)
# print(iphone.memorie_GB)
#
#
# iphone.upgrade_battery(4500)
# print(iphone.baterie_mAh)
...
laptop = Laptop("Dell XPS", 4500, 2024, "Windows 11", "Intel i7")
# print(laptop.numele)
# print(laptop.pretul)
...
#
# # Exemplu de upgrade
# laptop.upgrade_os("Windows 12")
# laptop.upgrade_processor("Intel i9")
# print(laptop.sistem_de_operare)
# print(laptop.procesor)
...
xiaomi_scooter=Trotineta('Xioaomi Mi Scooter',16000,2023,60,100)
print(xiaomi_scooter.numele)
print(xiaomi_scooter.pretul)
print(xiaomi_scooter.anul_producerii)
print(xiaomi_scooter.viteza_maxima)
print(xiaomi_scooter.autonomie_km)

xiaomi_scooter.upgrade_speed(80)
print(xiaomi_scooter.viteza_maxima)

xiaomi_scooter.upgrade_autonomy(120)
print(xiaomi_scooter.autonomie_km)
# CODUL TĂU VINE MAI SUS:
...
iphone_14 = AppleProduct("Iphone", 15000, 2020, "negru")
airpods = AppleProduct("Airpods", 1000, 2021, "alb")
print(iphone_14.combine_products(airpods))

iphone_15 = AppleProduct("Iphone",35000, 2025, "purple")
airpods_pro = AppleProduct("air_pods pro",35000, 2025, "purple")


print(iphone_15.combine_products(airpods_pro))
print(iphone_15.produs_conectat.numele)
...
class Magazin:
    ...
    def vinde_produs(self, produs):
        if isinstance(produs, Produs):
            return f"Produsul {produs.numele} a fost vandut cu succes"
...
iphone_13 = AppleProduct("Iphone 13", 15000, 2020, "negru")
print(magazin.vinde_produs(iphone_13))
print(magazin.returneaza_produs(iphone_13))
# CODUL TĂU VINE MAI SUS:
